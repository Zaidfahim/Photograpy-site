<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $image = $_FILES['products_image']['name'];
        $temp_image = $_FILES['products_image']['tmp_name'];
        $image_type = $_FILES['products_image']['type'];
        ...
        if (substr($image_type, 0, 5) == "image") {
            ...
            $stmt = $conn->prepare("INSERT INTO product (image_data, image_name) VALUES (?, ?)");
