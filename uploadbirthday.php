...
if (isset($_POST['submit'])) {
    ...
    $image = $_FILES['birthday_image']['name']; // Corrected the input name here
    $temp_image = $_FILES['birthday_image']['tmp_name'];
    $image_type = $_FILES['birthday_image']['type'];
    ...
    if (substr($image_type, 0, 5) == "image") {
        ...
        $stmt = $conn->prepare("INSERT INTO birthday (image_data, image_name) VALUES (?, ?)");
