<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $image = $_FILES['graduation_image']['name'];
        $temp_image = $_FILES['graduation_image']['tmp_name'];
        $image_type = $_FILES['graduation_image']['type'];
        ...
        if (substr($image_type, 0, 5) == "image") {
            ...
            $stmt = $conn->prepare("INSERT INTO graduation (image_data, image_name) VALUES (?, ?)");
