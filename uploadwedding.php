<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $image = $_FILES['wedding_image']['name'];
        $temp_image = $_FILES['wedding_image']['tmp_name'];
        $image_type = $_FILES['wedding_image']['type'];
        ...
        if (substr($image_type, 0, 5) == "image") {
            ...
            $stmt = $conn->prepare("INSERT INTO wedding (image_data, image_name) VALUES (?, ?)");
