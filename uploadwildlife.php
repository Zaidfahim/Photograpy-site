<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $image = $_FILES['wildlife_image']['name'];
        $temp_image = $_FILES['wildlife_image']['tmp_name'];
        $image_type = $_FILES['wildlife_image']['type'];
        ...
        if (substr($image_type, 0, 5) == "image") {
            ...
            $stmt = $conn->prepare("INSERT INTO wildlife (image_data, image_name) VALUES (?, ?)");
