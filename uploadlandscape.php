<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $image = $_FILES['landscape_image']['name'];
        $temp_image = $_FILES['landscape_image']['tmp_name'];
        $image_type = $_FILES['landscape_image']['type'];
        ...
        if (substr($image_type, 0, 5) == "image") {
            ...
            $stmt = $conn->prepare("INSERT INTO landscape (image_data, image_name) VALUES (?, ?)");
